...
Recurring reminder maintenance has independent checkpoints and the same 250-settings/window, 500-cancellation and 100-pair bounds. Claims recheck the active financial rule revision, current execution due date, reminder settings and recipient authorization. Generic payloads carry household/rule routing IDs, never amounts or financial details. Reminder delivery does not post a financial cycle. Source failures remain isolated, and receipt polling continues after maintenance failures.
