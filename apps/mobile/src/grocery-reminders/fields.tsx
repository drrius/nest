...
export function ReminderFieldsView({
  ...
  return (
    <Section title={context.grocery.name}>
      <Note>Checking, changing or removing this item invalidates its reminder.</Note>
      <Host
        matchContents
      ...
      >
        <Column spacing={12}>
          ...
          <TextInput value={fields.localDate} editable={!disabled} />
