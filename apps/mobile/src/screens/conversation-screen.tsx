      ...
      ListHeaderComponent={
        <>
          <Note>
            ...
            or notification preferences, or shared cooking settings. Memory additions and edits need
            your confirmation in the review screen. Calendar availability uses fresh opted-in busy
            times; permission and sharing changes open native settings. Money actions are not
            available here yet.
          </Note>
