      ...
      for v_function in select oid,oid::regprocedure::text as signature from pg_proc
        where pronamespace='public'::regnamespace and prokind='f'
          and left(proname,5)='nest_' and oid not in (
            ...
            'public.nest_read_legacy_adoption_approval(uuid,uuid)'::regprocedure,
            'public.nest_read_legacy_confirmation_approval(uuid,uuid)'::regprocedure,
            'public.nest_read_legacy_dismissal_approval(uuid,uuid)'::regprocedure,
            'public.nest_read_legacy_adoption(uuid,uuid)'::regprocedure,
            'public.nest_read_legacy_confirmation(uuid,uuid)'::regprocedure,
            'public.nest_read_legacy_dismissal(uuid,uuid)'::regprocedure,
