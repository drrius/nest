...
test("actual scheduler HTTP requires its separate secret and returns aggregate-only results", async (t) => {
  ...
  const handler = createPushSchedulerHandler(Redacted.make(secret), () =>
    Effect.sync(() => {
      ...
      return {
        ...
        groceryMaintenance: { status: "recorded", report: {} },
        recurringMaintenance: { status: "recorded", report: {} },
        choreDelivery: { status: "recorded", report: { complete: true, outcomes: [] } },
        mealDelivery: { status: "recorded", report: { complete: true, outcomes: [] } },
        groceryDelivery: { status: "recorded", report: { complete: true, outcomes: [] } },
        recurringDelivery: { status: "recorded", report: { complete: true, outcomes: [] } },
  ...
  assert.deepEqual(await response.json(), {
    ...
    groceryMaintenance: "recorded",
    recurringMaintenance: "recorded",
    choreDelivery: "recorded",
    mealDelivery: "recorded",
    groceryDelivery: "recorded",
    recurringDelivery: "recorded",
