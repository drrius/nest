...
-- The fixture write below proves transaction coupling, not financial invariants.
create table private.fixture_writes (invocation_id uuid primary key, payload jsonb);
