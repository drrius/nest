...
create table public.routines (
  ...
  archived_at timestamptz, paused_at timestamptz, unique(household_id, id)
);
...
insert into public.routines values
 ('10000000-0000-4000-8000-000000000001','00000000-0000-4000-8000-000000000010','Water plants',null,null),
 ('10000000-0000-4000-8000-000000000002','00000000-0000-4000-8000-000000000020','Private other home',null,null),
 ('10000000-0000-4000-8000-000000000003','00000000-0000-4000-8000-000000000010','Paused work',null,now());
...
insert into public.routine_occurrences values
 ...
 ('00000000-0000-4000-8000-000000000300','00000000-0000-4000-8000-000000000010',
