...
import { fixture as database, id } from "../database/meal-reminder-fixture.mjs";
import { postgrestFixture } from "./postgrest-fixture.mjs";
import { createHandler } from "../../apps/api/src/handler.ts";
import { nodeServer } from "../../apps/api/node-server.mjs";
import { mealReminderClient } from "../../apps/mobile/src/meal-reminders/client.ts";
export { id };
...
export async function fixture(t) {
  ...
  return { entryId: id(100), ...f, ...remote, config, url, client, native: client(), command };
}
