...
import { fixture as database, id } from "../database/grocery-reminder-fixture.mjs";
...
export async function fixture(t) {
  ...
  f.db.file(
    "supabase/migrations/20260926102725_native_grocery_reminder_nonretryable_conflicts.sql",
  );
  ...
  return { itemId: id(500), ...f, ...remote, config, url, client, native: client(), command };
}
