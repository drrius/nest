-- GATED additive candidate. One-off placement and private AI journal results commit atomically.
...
alter table public.nest_ai_commands add constraint nest_ai_commands_tool_name_check
  check(tool_name in ('placeMeal','completeChore','addGrocery','editGrocery','removeGrocery','checkGrocery',
...
create function private.nest_validate_ai_basic_command(p_tool text,p_input jsonb)
...
create function private.nest_dispatch_ai_basic_command(p_household uuid,p_operation uuid,p_tool text,p_input jsonb)
